...
steps=[
    ...
    # Set the top label
    EXEC(0,source="table.setTopLabel(\"Fixed Rows, adding columns\")"),
    # Define 4 rows, with labels and units
    EXEC(0,source="table.define(rows=['abc','def','ghi','jkl'], units=['m/s','','','miles'])"),
    # Fill in 4 columns, each with a label and values (numbers or strings)
	...
	# Replace the replace 3rd col (index=2), with new label and values
